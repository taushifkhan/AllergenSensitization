...
bootIter = 100
p_alpha  = 0.005
m1HD,_errHD = PS_Score(hdGT_bool,typing="HLA-HD",bootstrap=bootIter,pval_alpha=p_alpha)
m1LA,_errLA =  PS_Score(prgGT_bool,typing="HLA-PRG",bootstrap=bootIter,pval_alpha=p_alpha)
...
saveFlname = '../AssociationResults_34cutoff/PS_score_Model3_{}_{}.csv'.format(bootIter,current_time)
