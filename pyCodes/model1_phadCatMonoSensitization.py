...
igE_clinic = pd.read_csv("../data_curated/fx2_grading.csv").set_index("QBB_DUMMY_ID") # changed from 0.3 to 0.34 on 1June2022
...
# allele = C+b1 * allergenPanel + b2 * covariates [Test for 45 allele and 8 panel independently]
...
bootIter = 100
p_alpha  = 0.005
m1HD,_errHD = MonoSensitization(hdGT_bool,typing="HLA-HD",bootstrap=bootIter,pval_alpha=p_alpha)
m1LA,_errLA =  MonoSensitization(prgGT_bool,typing="HLA-PRG",bootstrap=bootIter,pval_alpha=p_alpha)
...
# saveFlname = '../AssociationResults_34cutoff/phad_MonoSensitization_Model1_{}_{}.csv'.format(bootIter,current_time)
saveFlname = '../AssociationResults_34cutoff/fx2_MonoSensitization_Model1_{}_{}.csv'.format(bootIter,current_time)
